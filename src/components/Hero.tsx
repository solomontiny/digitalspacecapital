    ...
    <section className="relative min-h-[90vh] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 md:px-8 lg:px-12">
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 text-center lg:text-right">
            ...
            <div className="mb-6 md:mb-10">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl text-white/80 leading-relaxed animate-fade-in lg:ml-auto lg:max-w-xl" style={{ animationDelay: '0.4s' }}>
            ...
            <div className="animate-fade-in flex justify-center lg:justify-end" style={{ animationDelay: '0.6s' }}>
              <Link to="/about">
                <Button 
                  size="lg" 
